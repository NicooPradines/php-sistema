...
<style>
	.body{
		background-image: url(https://media-exp1.licdn.com/dms/image/C561BAQEtPssD0MPHZw/company-background_10000/0/1592602939675?e=2159024400&v=beta&t=-fyCQBC4CDiuf2oithWk4wJ1ckyMfvzigHg9jKfNxZ8);
...
#photo
{
   ...
   <li><a href="logout.php" class="btn btn-danger">Cerrar sesión</a></li>
			...
			</form> <strong>CARGAR ARCHIVO</strong></tr></td></table>
							 <div class="col-md-18">
   ...
   <div class = "row">
	...
	<div id="footer">
&copy; Copyright 2021 - Derechos Reservados</a>
</div>
